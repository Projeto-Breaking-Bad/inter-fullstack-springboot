$(document).ready(function () {
    ...
    var apiBaseUrl = protocol === 'https:' ? 'https://newsapi.org' : 'http://newsapi.org';

    // Concatena a URL base com o restante da URL da API
    var apiUrl = apiBaseUrl + '/v2/everything?q=mercado+financeiro&language=pt&sortBy=publishedAt&apiKey=bce250e04146430b847c90b11eec9fd4';
